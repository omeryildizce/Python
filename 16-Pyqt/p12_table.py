...
# Form implementation generated from reading ui file 'p12_table.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(863, 466)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tableProducts = QtWidgets.QTableWidget(self.centralwidget)
        self.tableProducts.setGeometry(QtCore.QRect(10, 10, 531, 411))
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(550, 10, 311, 111))
